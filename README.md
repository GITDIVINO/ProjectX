...
The current release passes 189 automated tests. The MARKET import also passed a targeted browser check of all 30 reports and all regional filters, date warnings, image-transcribed rates, session restoration, mobile layout and unchanged voyage data. The broader browser script passed MARKET but stopped at an outdated VESSEL heading expectation; its remaining steps are not claimed as verified for this release. The financial engine was previously checked against 240 independent rational-arithmetic fixtures generated outside the calculation code. Validation against a complete real voyage remains outstanding.
