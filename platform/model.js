...
// The ballast leg starts where the vessel is delivered. Until that port is entered it is only a position.
const DELIVERY_PLACEHOLDER='Vessel position';
const deliveryName=s=>String(s.deliveryPort??'').trim()||DELIVERY_PLACEHOLDER;
