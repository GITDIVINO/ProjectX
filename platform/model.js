...
const PORT_PROFILES={
 ...
 'Santos':{pub151:'Santos, Brazil',lat:-23.98,lon:-46.3,waterDensity:1.015,country:'Brazil',terminal:'STS20, Outeirinhos, berths 22/23',maxDraft:11.3,maxLoa:null,maxBeam:null,maxAirDraft:null,maxDwt:null,notes:'Depth 11.3 m in the source study, not a permitted draft: check the current operational draft in the port table. The 283 m face is berths 22 and 23 combined, so it is not a single-ship LOA limit.'},
 'Paranaguá':{pub151:'Paranagua, Brazil',lat:-25.5,lon:-48.52,waterDensity:1.015,country:'Brazil',terminal:'TEFER, public fertilizer terminal',maxDraft:12.5,maxLoa:null,maxBeam:null,maxAirDraft:null,maxDwt:null,notes:'General published draft 12.5 m. A 2023 announcement gives 12.8 m at fertilizer berths 209/211; the lower figure is kept until confirmed.'},
 'Itaqui':{pub151:'Sao Luiz, Brazil',lat:-2.57,lon:-44.37,waterDensity:1.015,country:'Brazil',terminal:'COPI / public berths 100-103',maxDraft:12,maxLoa:null,maxBeam:null,maxAirDraft:null,maxDwt:null,notes:'Max draft 12 m in brackish water, supplied by the user 8 September 2026. Confirm the exact berth and the current draft, LOA and beam with EMAP/COPI.'},
 ...
 'Vitoria':{pub151:'Vitoria, Brazil',lat:-20.32,lon:-40.33,waterDensity:1.015,country:'Brazil',terminal:'Vports, Vila Velha terminal',maxDraft:12,maxLoa:null,maxBeam:null,maxAirDraft:null,maxDwt:null,notes:'Max draft 12 m in brackish water, supplied by the user 8 September 2026. Berth assignment and other limits are absent from the public profile used; confirm with Vports.'},
 'Rio Grande':{pub151:'Rio Grande, Brazil',lat:-32.13,lon:-52.1,waterDensity:1.01,country:'Brazil',terminal:'Yara Brasil Fertilizantes, North/South',maxDraft:12.19,maxLoa:null,maxBeam:null,maxAirDraft:null,maxDwt:null,notes:'South draft 12.19 m, North 10.0 m. The terminal limit prevails over the channel.'},
 'San Francisco do Sul':{pub151:'Sao Francisco Do Sul, Brazil',lat:-26.24,lon:-48.64,waterDensity:1.02,country:'Brazil',terminal:'Public berth 201 / Bulk Terminal',maxDraft:14,maxLoa:250,maxBeam:null,maxAirDraft:null,maxDwt:null,notes:'Draft 14 m, max LOA 250 m. Confirm the current structural and operational limits.'},
