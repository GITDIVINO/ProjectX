...
test('The shipped HTML preserves script bytes and every embedded script parses',()=>{
 ...
 ['arithmetic.js','cargo-catalog.js','model.js','market.js','guide.js','sea-data.js','sea-table.js','sea-route.js','planning.js','planner-ui.js','schema.js','storage-local.js','storage-supabase.js','storage.js','app.js'].forEach((name,i)=>{
